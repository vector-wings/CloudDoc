...
const saveFilesToStore = (files) => {
	// we don't have too store any info in file system, eg: isNew, body, etc
...
function App() {
	...
	const savedLocation = settingsStore.get('savedFileLocation') || remote.app.getPath('documents') // 获取文档文件夹地址
